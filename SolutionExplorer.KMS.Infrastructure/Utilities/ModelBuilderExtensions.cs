...
namespace SolutionExplorer.KMS.Infrastructure.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        /// <summary>
        /// Set GETDATE() sql function for all columns named "Id"
        /// </summary>
        /// <param name="modelBuilder"></param>
        /// <param name="mustBeIdentity">Set to true if you want only "Identity" guid fields that named "Id"</param>
        public static void AddCurrentDateTimeForCreatedDateConvention(this ModelBuilder modelBuilder)
        {
