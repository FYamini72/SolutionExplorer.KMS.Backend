...
namespace SolutionExplorer.KMS.Infrastructure.Migrations
{
    ...
    [Migration("20260227165206_PeriodicQCResult")]
    partial class PeriodicQCResult
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.ATCCCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MinAcceptedResult")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQCBaseInfoExpectedResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PeriodicQCBaseInfoExpectedResults");
                });

            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQCBaseInfoExpectedResultItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PeriodicQCBaseInfoExpectedResultId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PeriodicQCBaseInfoExpectedResultId");

                    b.ToTable("PeriodicQCBaseInfoExpectedResultItems");
                });
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControlCategoryResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PeriodicQualityControlCategoryResults");
                });

            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControlResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomResultTitle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("PeriodicQualityControlCategoryResultId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PeriodicQualityControlCategoryResultId");

                    b.ToTable("PeriodicQualityControlResults");
                });
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQCBaseInfoExpectedResult", b =>
                {
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.ATCCCategory", "ATCCCategory")
                        .WithMany()
                        .HasForeignKey("ATCCCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.QualityControlBaseInfo", "QualityControlBaseInfo")
                        .WithMany("PeriodicQCBaseInfoExpectedResults")
                        .HasForeignKey("QualityControlBaseInfoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ATCCCategory");
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQCBaseInfoExpectedResultItem", b =>
                {
                    ...
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.PeriodicQCBaseInfoExpectedResult", "PeriodicQCBaseInfoExpectedResult")
                        .WithMany("Items")
                        .HasForeignKey("PeriodicQCBaseInfoExpectedResultId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("PeriodicQCBaseInfoExpectedResult");
                });
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControlCategoryResult", b =>
                {
                    ...
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControl", "PeriodicQualityControl")
                        .WithMany("PeriodicQualityControlCategoryResults")
                        .HasForeignKey("PeriodicQualityControlId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControlResult", b =>
                {
                    ...
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControlCategoryResult", "PeriodicQualityControlCategoryResult")
                        .WithMany()
                        .HasForeignKey("PeriodicQualityControlCategoryResultId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("PeriodicQualityControlCategoryResult");
                });
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.QCBaseInfoAppearance", b =>
                {
                    ...
                    b.HasOne("SolutionExplorer.KMS.Domain.Entities.QualityControlBaseInfo", "QualityControlBaseInfo")
                        .WithMany("QCBaseInfoAppearances")
                        .HasForeignKey("QualityControlBaseInfoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.PeriodicQualityControl", b =>
                {
                    ...
                    b.Navigation("PeriodicQualityControlCategoryResults");
            ...
            modelBuilder.Entity("SolutionExplorer.KMS.Domain.Entities.QualityControlBaseInfo", b =>
                {
                    b.Navigation("PeriodicQCBaseInfoExpectedResults");

                    b.Navigation("QCBaseInfoAppearances");
